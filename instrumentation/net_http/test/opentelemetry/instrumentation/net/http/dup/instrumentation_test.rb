...
require_relative '../../../../../../lib/opentelemetry/instrumentation/net/http/patches/dup/instrumentation'
...
describe OpenTelemetry::Instrumentation::Net::HTTP::Instrumentation do
  ...
  describe '#request' do
    ...
    it 'merges http client attributes' do
      OpenTelemetry::Common::HTTP::ClientContext.with_attributes('peer.service' => 'foo', 'http.target' => 'REDACTED', 'url.path' => 'REDACTED') do
        Net::HTTP.get('example.com', '/success')
      end
