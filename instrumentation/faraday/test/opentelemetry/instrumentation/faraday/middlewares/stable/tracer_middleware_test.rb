...
require_relative '../../../../../../lib/opentelemetry/instrumentation/faraday/middlewares/stable/tracer_middleware'

describe OpenTelemetry::Instrumentation::Faraday::Middlewares::Stable::TracerMiddleware do
