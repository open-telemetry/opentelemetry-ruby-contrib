...
require_relative '../../../../../lib/opentelemetry/instrumentation/http_client/patches/old/client'

describe OpenTelemetry::Instrumentation::HttpClient::Patches::Old::Client do
