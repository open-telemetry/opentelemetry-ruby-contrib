...
require_relative '../../../../../lib/opentelemetry/instrumentation/http_client/patches/stable/session'

describe OpenTelemetry::Instrumentation::HttpClient::Patches::Stable::Session do
