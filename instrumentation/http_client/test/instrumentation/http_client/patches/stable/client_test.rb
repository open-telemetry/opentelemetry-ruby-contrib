...
require_relative '../../../../../lib/opentelemetry/instrumentation/http_client/patches/stable/client'

describe OpenTelemetry::Instrumentation::HttpClient::Patches::Stable::Client do
  ...
  describe '#do_request' do
    ...
    it 'merges http query attribute when present' do
      http = HTTPClient.new
      http.receive_timeout = 1
