...
require_relative '../../../../../../lib/opentelemetry/instrumentation/rack/middlewares/stable/tracer_middleware'

describe OpenTelemetry::Instrumentation::Rack::Middlewares::Stable::TracerMiddleware do
  ...
  let(:described_class) { OpenTelemetry::Instrumentation::Rack::Middlewares::Stable::TracerMiddleware }
