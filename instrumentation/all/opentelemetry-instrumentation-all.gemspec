...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-mysql2', '~> 0.22.0'
  spec.add_dependency 'opentelemetry-instrumentation-net_http', '~> 0.21.0'
  spec.add_dependency 'opentelemetry-instrumentation-pg', '~> 0.23.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-rack', '~> 0.22.0'
  spec.add_dependency 'opentelemetry-instrumentation-rails', '~> 0.23.1'
  spec.add_dependency 'opentelemetry-instrumentation-rake', '~> 0.1.0'
  spec.add_dependency 'opentelemetry-instrumentation-rdkafka', '~> 0.2.1'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-sinatra', '~> 0.21.1'
