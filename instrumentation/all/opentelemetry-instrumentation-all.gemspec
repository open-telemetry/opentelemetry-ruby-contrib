...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-dalli', '~> 0.29.0'
  spec.add_dependency 'opentelemetry-instrumentation-delayed_job', '~> 0.25.1'
  spec.add_dependency 'opentelemetry-instrumentation-ethon', '~> 0.27.0'
  spec.add_dependency 'opentelemetry-instrumentation-excon', '~> 0.27.0'
  spec.add_dependency 'opentelemetry-instrumentation-faraday', '~> 0.31.0'
  spec.add_dependency 'opentelemetry-instrumentation-grape', '~> 0.5.0'
  spec.add_dependency 'opentelemetry-instrumentation-graphql', '~> 0.31.1'
  spec.add_dependency 'opentelemetry-instrumentation-grpc', '~> 0.4.1'
  spec.add_dependency 'opentelemetry-instrumentation-gruf', '~> 0.5.0'
  spec.add_dependency 'opentelemetry-instrumentation-http', '~> 0.28.0'
  spec.add_dependency 'opentelemetry-instrumentation-http_client', '~> 0.27.0'
  spec.add_dependency 'opentelemetry-instrumentation-httpx', '~> 0.6.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-net_http', '~> 0.27.0'
