...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-ethon', '~> 0.26.0'
  spec.add_dependency 'opentelemetry-instrumentation-excon', '~> 0.26.0'
  spec.add_dependency 'opentelemetry-instrumentation-faraday', '~> 0.30.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-http', '~> 0.27.0'
  spec.add_dependency 'opentelemetry-instrumentation-http_client', '~> 0.26.0'
  spec.add_dependency 'opentelemetry-instrumentation-httpx', '~> 0.5.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-mysql2', '~> 0.32.1'
  spec.add_dependency 'opentelemetry-instrumentation-net_http', '~> 0.26.0'
  spec.add_dependency 'opentelemetry-instrumentation-pg', '~> 0.34.1'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-trilogy', '~> 0.65.1'
