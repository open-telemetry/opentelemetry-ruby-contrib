...
require_relative '../../../../../lib/opentelemetry/instrumentation/excon/middlewares/stable/tracer_middleware'
require_relative '../../../../../lib/opentelemetry/instrumentation/excon/patches/stable/socket'
  ...
  describe 'tracing' do
    ...
    it 'merges HTTP client context' do
      client_context_attrs = {
        'test.attribute' => 'test.value', 'http.request.method' => 'PATCH'
      }
