...
# This test suite requires a running trilogy container and dedicated test container
# To run tests:
# 1. Build the opentelemetry/opentelemetry-ruby-contrib image
# - docker-compose build
# 2. Bundle install
# - docker-compose run ex-instrumentation-trilogy-test bundle exec appraisal install
# 3. Run test suite
# - docker-compose run ex-instrumentation-trilogy-test bundle exec appraisal rake test
