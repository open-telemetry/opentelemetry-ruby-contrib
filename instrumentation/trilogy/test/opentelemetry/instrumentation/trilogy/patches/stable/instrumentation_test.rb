...
describe 'OpenTelemetry::Instrumentation::Trilogy (stable semconv)' do
  ...
  describe 'tracing' do
    ...
    describe 'with default options' do
      it 'obfuscates sql in db.query.text' do
        client.query('SELECT 1')
      ...
      it 'includes stable database connection information' do
        client.query('SELECT 1')
    ...
    describe 'when connecting' do
      ...
      it 'uses stable attributes for connect span' do
    ...
    describe 'when pinging' do
      ...
      it 'uses stable attributes for ping span' do
        _(client.connected_host).wont_be_nil
    ...
    describe 'when db_statement is set to include' do
      ...
      it 'includes the query in db.query.text' do
