...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    spec.metadata['changelog_uri'] = "https://open-telemetry.github.io/opentelemetry-ruby-contrib/opentelemetry-instrumentation-trilogy/v#{OpenTelemetry::Instrumentation::Trilogy::VERSION}/file.CHANGELOG.html"
    ...
    spec.metadata['documentation_uri'] = "https://open-telemetry.github.io/opentelemetry-ruby-contrib/opentelemetry-instrumentation-trilogy/v#{OpenTelemetry::Instrumentation::Trilogy::VERSION}"
  end
end
