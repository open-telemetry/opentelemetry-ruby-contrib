  ...
  module Propagator
    ...
    module XRay
      ...
      class TextMapPropagator
        ...
        XRAY_CONTEXT_REGEX = /\A(?:Self=([a-z0-9\-]{35});)?Root=(?<trace_id>([a-z0-9\-]{35}))(?:;Parent=(?<span_id>([a-z0-9]{16})))?(?:;Sampled=(?<sampling_state>[01d](?![0-9a-f])))?(?:;(?<trace_state>.*))?\Z/ # rubocop:disable Lint/MixedRegexpCaptureTypes
